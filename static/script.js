...
function calcHours(totalUnits){
    ...
    // let prepActivities = prepFunction();
    totalCourseHours = parseFloat((totalUnits * avgUnitLength).toFixed(2));
    console.log("hello", totalCourseHours);
...
function calcBuffer(totalWeeks){
    ...
    let totalWithBuffer = ((totalWeeks * buffer/ 100) + totalWeeks).toFixed(2);
    document.getElementById("totalBuffer").innerHTML = totalWithBuffer;
